...
class OtlpAgent {
  ...
  /// Null when [OtlpExporterConfig.tracesEnabled] is false (e.g. hybrid: OTLP metrics only).
  OtlpTraceExporter? get traceExporterIfEnabled => _traces;
  ...
  /// Null when [OtlpExporterConfig.metricsEnabled] is false.
  OtlpMeter? get meterIfEnabled {
    final m = _metrics;
  ...
  InstrumentedClient httpClient({http.Client? inner}) {
    return InstrumentedClient(
      otlpExporter: traceExporterIfEnabled,
      meter: meterIfEnabled,
