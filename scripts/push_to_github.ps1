# Sync this directory to https://github.com/songzhendong/skywalking-dart
param(
    [string]$Message = "chore: sync skywalking_dart"
)

$ErrorActionPreference = "Stop"
$repoUrl = "https://github.com/songzhendong/skywalking-dart.git"
$srcRoot = Split-Path -Parent $PSScriptRoot
$work = Join-Path $env:TEMP "skywalking-dart-push"
